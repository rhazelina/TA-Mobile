...
class RiwayatKehadiranGuruActivity : AppCompatActivity() {
        ...
        try {
            ...
            btnAssignment?.setOnClickListener {
                if (!isLoading) {
                    ...
                    updateTanggalDisplay()
                    loadDataAsync() // Load data tanpa filter
                    updateTombolAktif()
                    resetTextColors()
                ...
                withContext(Dispatchers.Main) {
                    if (response.isSuccessful && response.body() != null) {
                        ...
                        if (result.summary != null) {
                            ...
                            // If no summary, calculate from data
                            updateAngkaTombol()
                        }
    ...
    private fun toggleFilter(status: String) {
        try {
            ...
            updateTombolAktif()
            updateTextColors()
            loadDataAsync() // Reload data dengan filter baru
        } catch (e: Exception) {
    ...
    private fun updateTombolAktif() {
        try {
            ...
            btnHadir.setBackgroundColor(android.graphics.Color.parseColor("#F3F4F6"))
            btnSakit.setBackgroundColor(android.graphics.Color.parseColor("#F3F4F6"))
            btnIzin.setBackgroundColor(android.graphics.Color.parseColor("#F3F4F6"))
            btnAlpha.setBackgroundColor(android.graphics.Color.parseColor("#F3F4F6"))

            // Set aktif
            when (filterActive) {
                "hadir" -> btnHadir.setBackgroundColor(android.graphics.Color.parseColor("#10B981"))
                "sakit" -> btnSakit.setBackgroundColor(android.graphics.Color.parseColor("#F59E0B"))
                "izin" -> btnIzin.setBackgroundColor(android.graphics.Color.parseColor("#3B82F6"))
                "alpha" -> btnAlpha.setBackgroundColor(android.graphics.Color.parseColor("#EF4444"))
            }
        } catch (e: Exception) {
